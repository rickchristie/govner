...
[[ "$help_output" == *"Prepare a Linux host"* ]] || fail "help description is missing"
...
[[ "$check_output" == *"Docker"* ]] || fail "check report does not include Docker state"
[[ "$check_output" == *"Nested KVM"* ]] || fail "check report does not include nested KVM state"
